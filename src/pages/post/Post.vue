      ...
      <div class="DF JCC single_post">
        <div v-if="authStore.data.auth && windowSizeStore.objAdaptive.currentSize > 620" 
          ...
          <div class="single_post-side_bar-inner">
            <div class="post-side_bar-actions DF FDC AIC">
              ...
              <div @click="handlerSidebarScroll('top')" class="side_bar-inner_link"
              ...
              <div @click="handlerSidebarScroll('work')" class="side_bar-inner_link"
                @mouseover="objActionHover.work = true" 
                @mouseleave="objActionHover.work = false">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="20" cy="20" r="20" fill="white"></circle><path d="M19.1244 17.9908L19.1244 17.9909C19.2133 17.9929 19.3009 18.0131 19.3813 18.0503C19.46 18.0867 19.5303 18.1386 19.5875 18.2029L22.5358 20.9514L23.2774 20.112L23.2775 20.112L23.3524 20.1782C23.4004 20.1238 23.459 20.0792 23.5251 20.0468C23.5911 20.0144 23.6632 19.9949 23.7371 19.9895C23.811 19.9841 23.8853 19.9929 23.9557 20.0153C24.026 20.0377 24.0911 20.0733 24.147 20.12L19.1244 17.9908ZM19.1244 17.9908L19.1185 17.991C19.0274 17.9943 18.9378 18.0156 18.8553 18.0538C18.7729 18.0919 18.6992 18.1461 18.639 18.2133L18.6382 18.2142L16.5054 20.6537V17C16.5054 16.7867 16.5935 16.5813 16.7518 16.4293C16.9101 16.2771 17.1257 16.1909 17.3514 16.1909H24.9189C25.1445 16.1909 25.3601 16.2771 25.5185 16.4293C25.6767 16.5813 25.7649 16.7867 25.7649 17V21.2996L24.2111 20.0433C24.2109 20.0431 24.2107 20.0429 24.2105 20.0427L19.1244 17.9908ZM24.9189 14.9H17.3514C16.7741 14.9 16.2198 15.1203 15.8105 15.5137C15.4011 15.9072 15.1703 16.4417 15.1703 17V17.0818H15.0811C14.5039 17.0818 13.9496 17.3021 13.5402 17.6955C13.1308 18.089 12.9 18.6236 12.9 19.1818V25C12.9 25.5583 13.1308 26.0928 13.5402 26.4863C13.9496 26.8797 14.5039 27.1 15.0811 27.1H22.6486C23.2259 27.1 23.7802 26.8797 24.1895 26.4863C24.5989 26.0928 24.8297 25.5583 24.8297 25V24.9182H24.9189C25.4961 24.9182 26.0504 24.6979 26.4598 24.3045C26.8692 23.911 27.1 23.3764 27.1 22.8182V17C27.1 16.4417 26.8692 15.9072 26.4598 15.5137C26.0504 15.1203 25.4961 14.9 24.9189 14.9ZM17.3514 23.6273C17.1257 23.6273 16.9101 23.5411 16.7518 23.3889C16.5935 23.2368 16.5054 23.0315 16.5054 22.8182V22.6379L19.1893 19.6017L21.6621 21.9301L20.1667 23.6273H17.3514ZM23.4946 25C23.4946 25.2133 23.4065 25.4187 23.2482 25.5707C23.0899 25.7229 22.8743 25.8091 22.6486 25.8091H15.0811C14.8555 25.8091 14.6399 25.7229 14.4815 25.5707C14.3233 25.4187 14.2351 25.2133 14.2351 25V19.1818C14.2351 18.9685 14.3233 18.7632 14.4815 18.6111C14.6399 18.4589 14.8555 18.3727 15.0811 18.3727H15.1703V22.8182C15.1703 23.3764 15.4011 23.911 15.8105 24.3045C16.2198 24.6979 16.7741 24.9182 17.3514 24.9182H23.4946V25ZM24.9186 23.6273L21.9247 23.6273L23.8632 21.4364L25.7355 22.9621C25.7053 23.1369 25.6147 23.2982 25.4764 23.4191C25.3244 23.552 25.1258 23.6265 24.9189 23.6273C24.9188 23.6273 24.9187 23.6273 24.9186 23.6273Z" fill="black" stroke="black" stroke-width="0.2"></path></svg>
                <div v-if="objActionHover.work" class="side_bar_inner_link_tip">Работы</div>
              </div>
              <div @click="handlerSidebarScroll('useful')" class="side_bar-inner_link"
            ...
            <div class="post-side_bar-actions DF FDC AIC">
              ...
              <div @click="objModal.activeWorkModal = true" class="side_bar-inner_link"
                @mouseover="objActionHover.sendWork = true" 
                @mouseleave="objActionHover.sendWork = false">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="20" cy="20" r="20" fill="white"></circle><path d="M20 15V25M15 20H25" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                <div v-if="objActionHover.sendWork" class="side_bar_inner_link_tip">Отправить работу</div>
              </div>
              <div class="side_bar-inner_link"
                ...
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="20" cy="20" r="20" 
                    :fill="authStore.data.auth ? authStore.data.user.favorites.includes('0') ? 'black' : 'white' : ''"></circle>
                  <path d="M15.2694 19.889C14.0795 18.2593 14.4761 15.8148 16.4592 15C18.4423 14.1852 19.6321 15.8148 20.0287 16.6297C20.4253 15.8148 22.0118 14.1852 23.9948 15C25.9779 15.8148 25.9779 18.2593 24.7881 19.889C23.5982 21.5186 20.0287 24.7779 20.0287 24.7779C20.0287 24.7779 16.4592 21.5186 15.2694 19.889Z" 
                    :stroke="authStore.data.auth ? authStore.data.user.favorites.includes('0') ? 'white' : 'black' : ''" 
        ...
        <div class="single_post-body">
          ...
          <div class="single_post-content">
            ...
            <p v-if="authStore.data.auth" class="single_post-content_main_text">lorem*200 Дайджест материалов за январь 2023</p>
          </div>
