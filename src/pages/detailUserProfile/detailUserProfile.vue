    ...
    <div class="detail_user"
      ...
      <div v-if="windowSizeStore.objAdaptive.tablet || windowSizeStore.objAdaptive.desktop" class="profile_preview DF FDC JCSB">
        <div>
          ...
          <div v-if="objDetailUser.detailUser">
            <div v-if="objDetailUser.detailUser.video" class="profile_preview-card DF FDC JCC AIC">
            ...
            <div class="detail_user-data">
              <div v-if="objDetailUser.detailUser.country || objDetailUser.detailUser.city" class="user-data_item DF AIC">
              ...
              <a v-if="objDetailUser.detailUser.tg_name" href="https://t.me/va_lera_01" target="_blank" class="user-data_item DF AIC">
                <div class="user-data_item-icon">
              ...
              <div v-if="objDetailUser.detailUser.email_text" class="DF AIC">
                <div class="user-data_item-icon">
      ...
      <div v-if="objDetailUser.detailUser" class="profile_info">
        <div v-if="objNav.portfolio" class="profile-body">
          <router-link :to="`/users/${objDetailUser.detailUser.id}/works/${0}`" class="profile-body_item">
          ...
          <router-link :to="`/users/${objDetailUser.detailUser.id}/works/${1}`" class="profile-body_item">
            <div class="profile-body_item-bgk" style="background-image: url('https://kronadev.ru/upload/resize_cache/iblock/8b8/500_500_2/mbukeulj0npgbd6aden4kx1j4i7pmf1u.png')"></div>
          </router-link>
          <router-link :to="`/users/${objDetailUser.detailUser.id}/works/${0}`" class="profile-body_item">
            <div class="profile-body_item-bgk" style="background-image: url('https://kronadev.ru/upload/resize_cache/iblock/8b8/500_500_2/mbukeulj0npgbd6aden4kx1j4i7pmf1u.png')"></div>
