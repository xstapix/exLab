...
<template>
  <section v-if="objWork.work" :key="objWork.renderKey" class="detail-work_active" >
    ...
    <div class="DF FDC detail-work_content">
      <div class="detail-work_plug">
        <div v-if="objWork.work.fromLesson.type" class="detail-work_box">
      ...
      <div>
        <a href="/" class="DF AIC detail-work_author-info" v-if="objWork.work.fromAccount.type">
