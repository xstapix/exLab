    ...
    <section class="users_body">
      ...
      <table class="users_body-table">
        <thead>
          <tr>
            <th></th>
            <th><p class="table-head-title">Название аккаунта</p></th>
            <th>
              <div class="DF AIC table-head-item" @click="handlerSort('star')">
                <div>Звезды</div>
                <div :class="odjSortArrow.starArrow ? 'stark_rating-select_arrow_up' : 'stark_rating-select_arrow_down'"></div>
              </div>
            </th>
            <th>
              <div class="DF AIC table-head-item" @click="handlerSort('level')">
                <div>Уровень</div>
                <div :class="odjSortArrow.levelArrow ? 'stark_rating-select_arrow_up' : 'stark_rating-select_arrow_down'"></div>
              </div>
            </th>
            <th>
              <div class="DF AIC table-head-item" @click="handlerSort()">
                <div>В клубе</div>
        ...
        <tbody v-if="objUsers.users">
          <tr v-for="user in objUsers.users" :key="user.id">
            <td>
              <div class="DF AIC">
            ...
            <td>
              <div class="DF AIC">
                ...
                <p class="table_star-text">{{ user.star }}</p>
              </div>
            </td>
            <td>
              <div class="DF AIC">
                ...
                <p class="table_star-text">{{ user.level }}</p>
              </div>
            </td>
            <td>
              <div class="DF AIC">
                ...
                <p class="table_star-text">{{ user.inClub }}</p>
              </div>
            </td>
            <td>
              <div class="table_location DF AIC">
                ...
                <p class="table_location-text">{{ user.location }}</p>
              </div>
            </td>
          </tr>
        </tbody>
